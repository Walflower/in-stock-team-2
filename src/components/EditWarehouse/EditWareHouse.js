        ...
        <form id="details__form">
          <article className="details__container">
            ...
            <div className="details__subcontainer">
              <label htmlFor="location" className="details__label">
                Warehouse Name
              </label>
              <input
            ...
            <div className="details__subcontainer">
              <label htmlFor="street" className="details__label">
                Street Address
              </label>
              <input
                className="details__input"
          ...
          <div className="button">
            ...
            <button className="button__save" onClick={() => postData()}>
              Save
            </button>
